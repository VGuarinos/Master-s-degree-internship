...
time = 10         #number of years simulated
scene = "Post_2006" #choosing scenario and flux from excel file : Pre_EMT, 1987_1992, 1992_1994, 1994_2002, 2004_2006, Post_2006, Weaker_THC, Weaker_WMS_Stronger_EMS, Stronger_THC
...
while year <=time:  #Modeling "year" until "time" is over
    ...
    Ox_cons_EMIW = 1699e9 * (Ox_EMIW / (Ox_EMIW + Ks)) * step
    Ox_cons_EMDW = 503e9 * (Ox_EMDW / (Ox_EMDW + Ks)) * step
    Ox_cons_WMIW = 749e9 * (Ox_WMIW / (Ox_WMIW + Ks)) * step
    Ox_cons_WMDW = 665e9 * (Ox_WMDW / (Ox_WMDW + Ks)) * step
